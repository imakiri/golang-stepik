...
class Main(Tester):
    ...
    def _generate(self) -> List[Test]:
        ...
        message_WaitingForUserInput = Output("Enter command and data: ", "Please verify the correctness of the program."
        ...
        message_noteCreated = "[OK] The note was successfully created"
        message_listFull = "[Error] The list of notes is full"
        message_listCleared = "[OK] All notes were successfully deleted"

        tests = [
            new.testFromList([
                message_WaitingForUserInput,
                Input("create This is my first record!"), Output(message_noteCreated, ""),
                message_WaitingForUserInput,
                Input("create This is my second record!"), Output(message_noteCreated, ""),
                message_WaitingForUserInput,
                Input("list"),
                ...
                Output("Index 4:", ""),
                message_WaitingForUserInput,
                Input("create This is my third record!"), Output(message_noteCreated, ""),
                message_WaitingForUserInput,
                Input("create This is my forth record!"), Output(message_noteCreated, ""),
                message_WaitingForUserInput,
                Input("create This is my fifth record!"), Output(message_noteCreated, ""),
                message_WaitingForUserInput,
                Input("create This is my sixth record!"), Output(message_listFull, ""),
                message_WaitingForUserInput,
                Input("clear"), Output(message_listCleared, ""),
                message_WaitingForUserInput,
                Input("create This is my sixth record!"), Output(message_noteCreated, ""),
                message_WaitingForUserInput,
                Input("list"), Output("Index 0: This is my sixth record!\n", ""),
                Output("Index 1:", ""),
                Output("Index 2:", ""),
                Output("Index 3:", ""),
                Output("Index 4:", ""),
                message_WaitingForUserInput,
                Input("exit"), Output("Bye!", feedback_bye)
            ])
        ]
